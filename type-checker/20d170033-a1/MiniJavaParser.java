...
public class MiniJavaParser implements MiniJavaParserConstants {
  ...
  static final public FieldStoreStatement FieldStoreStatement() throws ParseException {
   ...
   Token n8;
    ...
    n8 = jj_consume_token(SEMICOLON);
            n7 = JTBToolkit.makeNodeToken(n8);
     {if (true) return new FieldStoreStatement(n0,n1,n3,n4,n6,n7);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public FieldLookup FieldLookup() throws ParseException {
   ...
   Identifier n3;
    ...
    n2 = jj_consume_token(DOT);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = Identifier();
     {if (true) return new FieldLookup(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10000000,0x10000000,0x8000000,0x0,0x8000000,0x0,0x8000000,0x2000,0x0,0x8000000,0x2000,0x0,0x2000,0x0,0x84000200,0x84000200,0x0,0x80000000,0x4000200,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x10010,0x80,0x10010,0x80,0x10010,0x12003,0x80000,0x10010,0x0,0x2003,0x12003,0x1,0x19840,0x19840,0x80000,0x19800,0x40,};
   }
