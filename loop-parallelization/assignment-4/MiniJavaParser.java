...
public class MiniJavaParser implements MiniJavaParserConstants {
  ...
  static final public ClassExtendsDeclaration ClassExtendsDeclaration() throws ParseException {
   ...
   Token n11;
    ...
    n11 = jj_consume_token(RBRACE);
     ...
     {if (true) return new ClassExtendsDeclaration(n0,n2,n3,n5,n6,n8,n10);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ArrayAssignmentStatement ArrayAssignmentStatement() throws ParseException {
   NodeChoice n0;
   ArrayAssignArithemeticExpression n1;
   ArrayAssignArrayOrIntegerLiteralorIdentifier n2;
    if (jj_2_7(2147483647)) {
      n1 = ArrayAssignArithemeticExpression();
        n0 = new NodeChoice(n1, 0);
    } else if (jj_2_8(2147483647)) {
      n2 = ArrayAssignArrayOrIntegerLiteralorIdentifier();
        n0 = new NodeChoice(n2, 1);
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
     {if (true) return new ArrayAssignmentStatement(n0);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ForStatement ForStatement() throws ParseException {
   ...
   ParallelAnnotation n5;
   Identifier n6;
   NodeToken n7;
   Token n8;
   IntegerOrIdentifier n9;
   NodeToken n10;
   Token n11;
   RelopExpression n12;
   NodeToken n13;
   Token n14;
   UpdateLoopInductionVariable n15;
   NodeToken n16;
   Token n17;
   Statement n18;
    ...
    n8 = jj_consume_token(ASSIGN);
            n7 = JTBToolkit.makeNodeToken(n8);
    n9 = IntegerOrIdentifier();
    n11 = jj_consume_token(SEMICOLON);
             n10 = JTBToolkit.makeNodeToken(n11);
    n12 = RelopExpression();
    n14 = jj_consume_token(SEMICOLON);
             n13 = JTBToolkit.makeNodeToken(n14);
    n15 = UpdateLoopInductionVariable();
    n17 = jj_consume_token(RPAREN);
             n16 = JTBToolkit.makeNodeToken(n17);
    n18 = Statement();
     {if (true) return new ForStatement(n0,n2,n4,n6,n7,n9,n10,n12,n13,n15,n16,n18);}
    throw new Error("Missing return statement in function");
  }

  static final public ParallelAnnotation ParallelAnnotation() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n5;
    n1 = jj_consume_token(SCOMMENT1);
                    n0 = JTBToolkit.makeNodeToken(n1);
    n3 = jj_consume_token(PARALLEL_ANNOTATION);
                              n2 = JTBToolkit.makeNodeToken(n3);
    n5 = jj_consume_token(SCOMMENT2);
                    n4 = JTBToolkit.makeNodeToken(n5);
     {if (true) return new ParallelAnnotation(n0,n2,n4);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public RelopExpression RelopExpression() throws ParseException {
   NodeChoice n0;
   LTEExpression n1;
   LTExpression n2;
   GTEExpression n3;
   ...
   EQExpression n6;
    if (jj_2_25(2147483647)) {
     ...
     {if (true) return new RelopExpression(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public UpdateLoopInductionVariable UpdateLoopInductionVariable() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   ArithemeticExpression n3;
    n0 = Identifier();
    n2 = jj_consume_token(ASSIGN);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = ArithemeticExpression();
     {if (true) return new UpdateLoopInductionVariable(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }

  static final public ArithemeticExpression ArithemeticExpression() throws ParseException {
   NodeChoice n0;
   PlusExpression n1;
   MinusExpression n2;
   TimesExpression n3;
   DivExpression n4;
    if (jj_2_31(2147483647)) {
     ...
     {if (true) return new ArithemeticExpression(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public ArrayorIdentifierorIntegerLiteral ArrayorIdentifierorIntegerLiteral() throws ParseException {
   NodeChoice n0;
   ArrayLookup n1;
   Identifier n2;
   IntegerLiteral n3;
    if (jj_2_35(2)) {
     ...
     {if (true) return new ArrayorIdentifierorIntegerLiteral(n0);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public LTEExpression LTEExpression() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   IntegerOrIdentifier n3;
    n0 = Identifier();
    n2 = jj_consume_token(LE);
             n1 = JTBToolkit.makeNodeToken(n2);
    n3 = IntegerOrIdentifier();
     {if (true) return new LTEExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public LTExpression LTExpression() throws ParseException {
   ...
   IntegerOrIdentifier n3;
    ...
    n2 = jj_consume_token(57);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = IntegerOrIdentifier();
     {if (true) return new LTExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }

  static final public GTEExpression GTEExpression() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   IntegerOrIdentifier n3;
    ...
    n2 = jj_consume_token(56);
             n1 = JTBToolkit.makeNodeToken(n2);
    n3 = IntegerOrIdentifier();
     {if (true) return new GTEExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public GTExpression GTExpression() throws ParseException {
   ...
   IntegerOrIdentifier n3;
    ...
    n2 = jj_consume_token(58);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = IntegerOrIdentifier();
     {if (true) return new GTExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public PlusExpression PlusExpression() throws ParseException {
   ArrayorIdentifierorIntegerLiteral n0;
   NodeToken n1;
   Token n2;
   ArrayorIdentifierorIntegerLiteral n3;
    n0 = ArrayorIdentifierorIntegerLiteral();
    n2 = jj_consume_token(PLUS);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = ArrayorIdentifierorIntegerLiteral();
  ...
  static final public IntegerOrIdentifier IntegerOrIdentifier() throws ParseException {
   NodeChoice n0;
   IntegerLiteral n1;
   Identifier n2;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    default:
     ...
     {if (true) return new IntegerOrIdentifier(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public ArrayAssignArithemeticExpression ArrayAssignArithemeticExpression() throws ParseException {
   ArrayLookup n0;
   NodeToken n1;
   Token n2;
   ArithemeticExpression n3;
   ...
   Token n5;
    ...
    n5 = jj_consume_token(SEMICOLON);
            n4 = JTBToolkit.makeNodeToken(n5);
     {if (true) return new ArrayAssignArithemeticExpression(n0,n1,n3,n4);}
    throw new Error("Missing return statement in function");
  }

  static final public ArrayAssignArrayOrIntegerLiteralorIdentifier ArrayAssignArrayOrIntegerLiteralorIdentifier() throws ParseException {
   ArrayLookup n0;
   NodeToken n1;
   Token n2;
   ArrayorIdentifierorIntegerLiteral n3;
   ...
   Token n5;
    ...
    n5 = jj_consume_token(SEMICOLON);
            n4 = JTBToolkit.makeNodeToken(n5);
     {if (true) return new ArrayAssignArrayOrIntegerLiteralorIdentifier(n0,n1,n3,n4);}
    throw new Error("Missing return statement in function");
  }
  ...
  static private boolean jj_3R_101() {
    ...
    if (jj_scan_token(PARALLEL_ANNOTATION)) return true;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10000000,0x1000,0x10000000,0x0,0x0,0xc000000,0x1000,0x0,0xc000000,0x1000,0x0,0x1000,0x0,0x0,0x82000000,0x0,0x0,0x0,0x80000000,0x2000000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x104007,0x0,0x100,0x100,0x100020,0x104007,0x800000,0x100020,0x0,0x4007,0x104007,0x1,0x10000,0x183080,0x180000,0x100000,0x800000,0x183000,0x80,0x180000,};
   }
